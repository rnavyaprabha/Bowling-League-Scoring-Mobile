            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(0.0, 12.0, 0.0, 0.0),
                  child: FutureBuilder<ApiCallResponse>(
                    future: LeaguesGroup.getAllLeaguesCall.call(
                      jwt: currentAuthenticationToken,
                    ),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      ...
                      final listViewGetAllLeaguesResponse = snapshot.data!;
                      return Builder(
                        builder: (context) {
                          final allLeagueValue = LeaguesGroup.getAllLeaguesCall
                                  .leagues(
                                    listViewGetAllLeaguesResponse.jsonBody,
                                  )
                                  ?.toList() ??
                              [];
                          return ListView.builder(
                            ...
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: allLeagueValue.length,
                            itemBuilder: (context, allLeagueValueIndex) {
                              final allLeagueValueItem =
                                  allLeagueValue[allLeagueValueIndex];
                              return Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    16.0, 0.0, 16.0, 8.0),
                                child: Container(
