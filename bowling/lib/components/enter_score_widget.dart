                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              0.0, 0.0, 14.0, 0.0),
                          child: Text(
                            'Handicap: ${currentUserData?.average.toString()}',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      _model.addScore = await GamesGroup
                                          .registerScoreCall
                                          .call(
                                        playeId: currentUserData?.playerId,
                                        jwt: currentAuthenticationToken,
                                        g1score: int.tryParse(
                                            _model.textController1.text),
                                        g2score: int.tryParse(
                                            _model.textController2.text),
                                        g3score: int.tryParse(
                                            _model.textController3.text),
                                        gameId: widget.gameId,
                                        teamId: widget.teamId,
                                      );
                                      if ((_model.addScore?.succeeded ??
                                          true)) {
                                        Navigator.pop(context);
