...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    bowlingAuthUserSubject.add(
      BowlingAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<BowlingAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  BowlingAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = BowlingAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    bowlingAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
