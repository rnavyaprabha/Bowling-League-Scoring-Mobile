...
export 'leagues_model.dart';


class LeaguesWidget extends StatefulWidget {
  const LeaguesWidget({super.key});
...
class _LeaguesWidgetState extends State<LeaguesWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeaguesModel());
                            ...
                            child: Column(
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: Image.network(
                                    'https://www.auburnbowl.com/Portals/0/BlockBuilderImages/401/website_designsYouth%20Bowlers%20Promo1.jpg',
                                    width: double.infinity,
                                    height: 200.0,
                                    fit: BoxFit.cover,
                                  ),
